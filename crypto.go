// Copypasted from github.com/restic/restic/internal/crypto
// go compiler doesn't let to use internal package in import
// original License is BSD 2-Clause "Simplified" License
